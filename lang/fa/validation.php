...
return [
    ...
    'attributes' => [
        ...
        'subscriptions.*.name' => 'نام اشتراک',
        'subscriptions.*.instructor_id' => 'مربی',
        'subscriptions.*.class_days' => 'روزهای کلاس',
        'subscriptions.*.start_time' => 'ساعت شروع',
        'subscriptions.*.end_time' => 'ساعت پایان',
        'subscriptions.*.session_count' => 'تعداد جلسات',
        'subscriptions.*.class_types' => 'نوع کلاس',
        'subscriptions.*.duration_value' => 'مقدار مدت',
        'subscriptions.*.duration_unit' => 'واحد مدت',
        'subscriptions.*.status' => 'وضعیت اشتراک',
        'subscriptions.*.price' => 'قیمت اشتراک', 'subscription_name' => 'نام اشتراک',
        'instructor' => 'مربی',
        'class_days' => 'روزهای کلاس',
        'class_days.*' => 'روز کلاس',
        'start_time' => 'ساعت شروع',
        'end_time' => 'ساعت پایان',
        'session_count' => 'تعداد جلسات',
        'class_type' => 'نوع کلاس',
        'duration_value' => 'مدت دوره',
